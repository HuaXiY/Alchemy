...
@Hook.Provider
@EntityMapping("magic_pixie")
public class EntityMagicPixie extends EntityPixie implements IFollower {
	
	protected static final Hook.Result light_level = new Hook.Result(15);
	
	@Hook(value = "DynamicLights#getLightLevel", isStatic = true)
	public static Hook.Result getLightLevel(Entity entity) {
		return entity instanceof EntityPixie ? light_level : Hook.Result.VOID;
	}
	
	public static final DataParameter<Optional<UUID>> owner_uuid = EntityDataManager.<Optional<UUID>>createKey(EntityMagicPixie.class,
	...
	public EntityMagicPixie(World world) {
		super(world);
