package index.alchemy.client.gui;
...
@Proxy(GuiInventory.class)
public class GuiInventoryBauble extends InventoryEffectRenderer
{
    ...
    public GuiInventoryBauble(ContainerInventoryBauble container)
    {
        super(container);
        allowUserInput = true;
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        drawTexturedModalRect(i + 76, j + 7, 7, 7, 18, 18 * 4);
        drawTexturedModalRect(i + 96, j + 61, 76, 61, 18, 18);
