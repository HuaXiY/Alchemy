...
public class AlchemyTransformerManager implements IClassTransformer {
	...
	@Unsafe(Unsafe.ASM_API)
	public static void loadTransforms(ClassNode node, ClassInfo info) throws Exception {
		loadPatch(node);
		loadField(node);
		loadRemote(node);
		loadProxy(node);
	...
	@Unsafe(Unsafe.ASM_API)
	public static void loadRemote(ClassNode node) throws Exception {
	...
	@Unsafe(Unsafe.ASM_API)
	public static void loadPatch(ClassNode node) throws Exception {
		if (node.visibleAnnotations != null)
	...
	@Unsafe(Unsafe.ASM_API)
	public static void loadHook(ClassNode node) throws Exception {
		if (node.visibleAnnotations != null)
			for (AnnotationNode nann : node.visibleAnnotations)
	...
	@Unsafe(Unsafe.ASM_API)
	public static void loadProxy(ClassNode node) throws Exception {
		if (node.visibleAnnotations != null)
			for (AnnotationNode nann : node.visibleAnnotations)
	...
	@Unsafe(Unsafe.ASM_API)
	public static void loadField(ClassNode node) throws Exception {
		if (node.visibleAnnotations != null)
			for (AnnotationNode nann : node.visibleAnnotations)
	...
	@Unsafe(Unsafe.ASM_API)
	public static void loadTransform(ClassNode node, Supplier<IAlchemyClassTransformer> supplier) throws Exception {
