...
public class DMain {
    ...
    public static void init(Class<?> clazz) {
        ...
        if (lang != null && $.isSubclass(Enum.class, clazz)) {
            try {
                Enum<?> enums[] = (Enum[]) $.setAccessible(clazz.getDeclaredField("ENUM$VALUES")).get(null);
                String prefix = (String) $.setAccessible(clazz.getDeclaredField("PREFIX")).get(null);
                for (Enum<?> e : enums)
