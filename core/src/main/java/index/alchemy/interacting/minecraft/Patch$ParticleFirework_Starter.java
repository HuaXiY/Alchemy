...
public class Patch$ParticleFirework_Starter extends ParticleFirework.Starter {
    ...
    public Patch$ParticleFirework_Starter(World world, double x, double y, double z, double mx, double my, double mz,
